...
The example below uses the `PageRank algorithm <https://en.wikipedia.org/wiki/PageRank>`__ to calculate the centrality (relative importance) of nodes in the graph.
